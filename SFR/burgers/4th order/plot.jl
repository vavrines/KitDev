...
plot(x, u0[end][:, 2], label="No filter", lw=1.5, color=:gray27, xlabel="x", ylabel="standard deviation")
...
plot(x, u0[end][:, 1], label="No filter", lw=1.5, color=:gray27, xlabel="x", ylabel="expected value")
